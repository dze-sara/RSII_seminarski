           ...
           migrationBuilder.InsertData(
            ...
            migrationBuilder.InsertData(
               ...
               values: new object[,]
               {
                   ...
                   {8, new DateTime(2022, 6, 13, 12, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2022, 6, 30, 12, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2021, 3, 16, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2021, 3, 16, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, 7, decimal.Parse("490") },
                   {9, new DateTime(2022, 6, 15, 12, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2022, 7, 10, 12, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2021, 3, 16, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2021, 3, 16, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, 1, decimal.Parse("1120") },
                   {10, new DateTime(2022, 6, 10, 12, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2022, 7, 10, 12, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2021, 3, 16, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2021, 3, 16, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, 2, decimal.Parse("2000") },
                   {11, new DateTime(2022, 6, 12, 12, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2022, 7, 2, 12, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2021, 3, 16, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2021, 3, 16, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, 3, decimal.Parse("785") }
               });
        }
